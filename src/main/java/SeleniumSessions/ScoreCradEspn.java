...
public class ScoreCradEspn {
	...
	public static void main(String[] args) {
	 ...
	 public static String getWicketKeeper(WebDriver driver, String playername) {
		 ...
		 String text =driver.findElement(By.xpath("//a[text()='"+playername+"']//parent::td//following-sibling::td//span[text()]")).getText();
	 ...
	 public static ArrayList<String> getScoreCard(WebDriver driver, String playername) {
		 ...
		 List<WebElement> scoreList=driver.findElements(By.xpath("//a[text()='"+playername+"']//parent::td//following-sibling::td/following-sibling::td[text()]"));
